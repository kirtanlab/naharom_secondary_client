...
import { useGetAdminLedger } from 'src/queries/ledger';
...
export default function AdminLedgerView() {
    ...
    return (
        <Container maxWidth={settings.themeStretch ? false : 'xl'}>
            <Typography variant="h4">Admin Ledger </Typography>
            <Grid xs={12} marginTop={2}>
                {/* <Box
        sx={{
          mt: 5,
      ...
      /> */}
                ...
                <AdminLedgerTable tableData={AllUsers} TABLE_HEAD={TABLE_HEAD} />
            </Grid>
        </Container>
    );
}
